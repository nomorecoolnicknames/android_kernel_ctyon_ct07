...
- **1.3 Сборка HEAD** скриптом 0.2 → ожидаемый `zImage-dtb` SHA
  `03986251060198e7b950d2df7e03fbeecd4959ae309396f840bf5be1c45b744e`
  (расхождение — разбираться ДО прошивки); repack с проверенным p7-ramdisk
  TWRP 3.7 (`7a321f5d…`), маркер `androidboot.ct07src=fix2-<nonce>`;
  **прошить только p8**, p7 не трогать.
